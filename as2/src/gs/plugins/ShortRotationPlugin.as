...
DESCRIPTION:
	...
	For example, if myObject._rotation is currently 170 degrees and you want to tween it to -170 degrees, 
	a normal _rotation tween would travel a total of 340 degrees in the counter-clockwise direction, 
	...
	easier, like TweenMax.to(myPV3DObject, 2, {shortRotation:{rotationX:-170, rotationY:35, rotationZ:200}});
...
class gs.plugins.ShortRotationPlugin extends TweenPlugin {
